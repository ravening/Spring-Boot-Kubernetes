...
```
$ docker image tag admindashboard rakgenius/admindashboard
$ docker push rakgenius/admindashboard
$ docker image tag customerdashboard rakgenius/customerdashboard
$ docker push rakgenius/customerdashboard
$ docker image tag virtualmachine rakgenius/virtualmachine
$ docker push rakgenius/virtualmachine
$ docker image tag privatecloud rakgenius/privatecloud
$ docker push rakgenius/privatecloud
$ docker image tag cloudstack rakgenius/cloudstack
$ docker push rakgenius/cloudstack
$ docker image tag customeraccount rakgenius/customeraccount
$ docker push rakgenius/customeraccount
$ docker image tag orders rakgenius/orders
$ docker push rakgenius/orders
```
...
$ kubectl get svc customerdashboard -n jhipster
```
